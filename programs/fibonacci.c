...
int main() {
    ...
    start = clock();
    printf("Fibonacci recursion result: %d\n", fib_rec(n));
    end = clock();
    printf("Time taken by fib_rec: %f seconds\n", (double)(end - start) / CLOCKS_PER_SEC);

    // Test Fibonacci memoization
    start = clock();
    printf("Fibonacci memoization result: %d\n", fib_memo(n));
    end = clock();
    printf("Time taken by fib_memo: %f seconds\n", (double)(end - start) / CLOCKS_PER_SEC);

    // Test Fibonacci dynamic programming
    start = clock();
    printf("Fibonacci dynamic programming result: %d\n", fib_dp(n));
    end = clock();
